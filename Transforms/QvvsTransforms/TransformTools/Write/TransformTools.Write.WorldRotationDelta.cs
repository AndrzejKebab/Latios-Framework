...
namespace Latios.Transforms
{
    public static unsafe partial class TransformTools
    {
        ...
        public static void RotateWorld(Entity entity, quaternion rotationToApply, ref ComponentBroker componentBroker)
        {
        ...
        /// <param name="componentBroker">A ComponentBroker with write access to WorldTransform and read access to RootReference, EntityInHierarchy, and EntityInHierarchyCleanup</param>
        public static void RotateWorld(Entity entity, quaternion rotationToApply, TransformsKey key, ref ComponentBroker componentBroker)
        {
            var handle = GetHierarchyHandle(entity, ref componentBroker);
            if (handle.isNull)
            {
        ...
        /// <param name="rotationToApply">Rotates by this rotation delta</param>
        /// <param name="componentBroker">A ComponentBroker with write access to WorldTransform and read access to RootReference, EntityInHierarchy, and EntityInHierarchyCleanup</param>
        public static void RotateWorld(EntityInHierarchyHandle handle, quaternion rotationToApply, ref ComponentBroker componentBroker)
        {
            if (handle.isCopyParent)
                return;
        ...
        /// <param name="key">A key to ensure the hierarchy is safe to access</param>
        /// <param name="componentBroker">A ComponentBroker with write access to WorldTransform and read access to RootReference, EntityInHierarchy, and EntityInHierarchyCleanup</param>
        public static void RotateWorld(EntityInHierarchyHandle handle, quaternion rotationToApply, TransformsKey key, ref ComponentBroker componentBroker)
        {
            if (handle.isCopyParent)
                return;
        ...
        #region Apply Ticked World Rotation Delta
        /// <summary>
        ...
        public static void RotateTickedWorld(Entity entity, quaternion rotationToApply, ref ComponentBroker componentBroker)
        {
            var handle = GetHierarchyHandle(entity, ref componentBroker);
            if (handle.isNull)
            {
        ...
        /// <param name="key">A key to ensure the hierarchy is safe to access</param>
        /// <param name="componentBroker">A ComponentBroker with write access to TickedWorldTransform and read access to RootReference, EntityInHierarchy, and EntityInHierarchyCleanup</param>
        public static void RotateTickedWorld(Entity entity, quaternion rotationToApply, TransformsKey key, ref ComponentBroker componentBroker)
        {
            var handle = GetHierarchyHandle(entity, ref componentBroker);
            if (handle.isNull)
            {
        ...
        /// <param name="rotationToApply">Rotates by this rotation delta</param>
        /// <param name="componentBroker">A ComponentBroker with write access to TickedWorldTransform and read access to RootReference, EntityInHierarchy, and EntityInHierarchyCleanup</param>
        public static void RotateTickedWorld(EntityInHierarchyHandle handle, quaternion rotationToApply, ref ComponentBroker componentBroker)
        {
            if (handle.isCopyParent)
                return;
        ...
        /// <param name="key">A key to ensure the hierarchy is safe to access</param>
        /// <param name="componentBroker">A ComponentBroker with write access to TickedWorldTransform and read access to RootReference, EntityInHierarchy, and EntityInHierarchyCleanup</param>
        public static void RotateTickedWorld(EntityInHierarchyHandle handle, quaternion rotationToApply, TransformsKey key, ref ComponentBroker componentBroker)
        {
            if (handle.isCopyParent)
                return;
            key.Validate(handle.root.entity);
