...
{
    [IJobEach.ParameterHandle(typeof(TickedTransformReadAspectParameterHandle), IJobEach.ScheduleModeMask.All)]
    [NativeContainer]
    public unsafe struct TickedTransformReadAspect : IJobEach.IParameter
    {
