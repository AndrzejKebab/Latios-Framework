...
namespace Latios.Transforms
{
    public static unsafe partial class TransformTools
    {
        ...
        public static void TranslateWorld(Entity entity, float3 translation, ref ComponentBroker componentBroker)
        {
        ...
        /// <param name="componentBroker">A ComponentBroker with write access to WorldTransform and read access to RootReference, EntityInHierarchy, and EntityInHierarchyCleanup</param>
        public static void TranslateWorld(Entity entity, float3 translation, TransformsKey key, ref ComponentBroker componentBroker)
        {
            var handle = GetHierarchyHandle(entity, ref componentBroker);
            if (handle.isNull)
            {
        ...
        /// <param name="translation">Translates by this position delta</param>
        /// <param name="componentBroker">A ComponentBroker with write access to WorldTransform and read access to RootReference, EntityInHierarchy, and EntityInHierarchyCleanup</param>
        public static void TranslateWorld(EntityInHierarchyHandle handle, float3 translation, ref ComponentBroker componentBroker)
        {
            if (handle.isCopyParent)
                return;
        ...
        /// <param name="key">A key to ensure the hierarchy is safe to access</param>
        /// <param name="componentBroker">A ComponentBroker with write access to WorldTransform and read access to RootReference, EntityInHierarchy, and EntityInHierarchyCleanup</param>
        public static void TranslateWorld(EntityInHierarchyHandle handle, float3 translation, TransformsKey key, ref ComponentBroker componentBroker)
        {
            if (handle.isCopyParent)
                return;
        ...
        #region Apply Ticked World Position Delta
        /// <summary>
        ...
        public static void TranslateTickedWorld(Entity entity, float3 translation, ref ComponentBroker componentBroker)
        {
            var handle = GetHierarchyHandle(entity, ref componentBroker);
            if (handle.isNull)
            {
        ...
        /// <param name="key">A key to ensure the hierarchy is safe to access</param>
        /// <param name="componentBroker">A ComponentBroker with write access to TickedWorldTransform and read access to RootReference, EntityInHierarchy, and EntityInHierarchyCleanup</param>
        public static void TranslateTickedWorld(Entity entity, float3 translation, TransformsKey key, ref ComponentBroker componentBroker)
        {
            var handle = GetHierarchyHandle(entity, ref componentBroker);
            if (handle.isNull)
            {
        ...
        /// <param name="translation">Translates by this position delta</param>
        /// <param name="componentBroker">A ComponentBroker with write access to TickedWorldTransform and read access to RootReference, EntityInHierarchy, and EntityInHierarchyCleanup</param>
        public static void TranslateTickedWorld(EntityInHierarchyHandle handle, float3 translation, ref ComponentBroker componentBroker)
        {
            if (handle.isCopyParent)
                return;
        ...
        /// <param name="key">A key to ensure the hierarchy is safe to access</param>
        /// <param name="componentBroker">A ComponentBroker with write access to TickedWorldTransform and read access to RootReference, EntityInHierarchy, and EntityInHierarchyCleanup</param>
        public static void TranslateTickedWorld(EntityInHierarchyHandle handle, float3 translation, TransformsKey key, ref ComponentBroker componentBroker)
        {
            if (handle.isCopyParent)
                return;
            key.Validate(handle.root.entity);
