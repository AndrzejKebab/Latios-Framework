...
namespace Latios.Transforms
{
    public static unsafe partial class TransformTools
    {
        ...
        public static void SetLocalPosition(Entity entity, float3 newLocalPosition, ref ComponentBroker componentBroker)
        {
            ...
            SetLocalPosition(handle, newLocalPosition, ref componentBroker);
        }
        ...
        /// <param name="componentBroker">A ComponentBroker with write access to WorldTransform and read access to RootReference, EntityInHierarchy, and EntityInHierarchyCleanup</param>
        public static void SetLocalPosition(Entity entity, float3 newLocalPosition, TransformsKey key, ref ComponentBroker componentBroker)
        {
            var handle = GetHierarchyHandle(entity, ref componentBroker);
            if (handle.isNull)
            {
        ...
        /// <param name="newLocalPosition">The new local position value</param>
        /// <param name="componentBroker">A ComponentBroker with write access to WorldTransform and read access to RootReference, EntityInHierarchy, and EntityInHierarchyCleanup</param>
        public static void SetLocalPosition(EntityInHierarchyHandle handle, float3 newLocalPosition, ref ComponentBroker componentBroker)
        {
            if (handle.isCopyParent)
                return;
        ...
        /// <param name="key">A key to ensure the hierarchy is safe to access</param>
        /// <param name="componentBroker">A ComponentBroker with write access to WorldTransform and read access to RootReference, EntityInHierarchy, and EntityInHierarchyCleanup</param>
        public static void SetLocalPosition(EntityInHierarchyHandle handle, float3 newLocalPosition, TransformsKey key, ref ComponentBroker componentBroker)
        {
            if (handle.isCopyParent)
                return;
                                            ...
                                            ref BufferLookup<EntityInHierarchyCleanup>    entityInHierarchyCleanupLookupRO)
        {
            ...
            SetLocalPosition(handle, newLocalPosition, ref transformLookupRW.GetCheckedLookup(entity, key), ref entityStorageInfoLookup);
        }
        ...
        #region Set Ticked Local Position
        /// <summary>
        ...
        public static void SetTickedLocalPosition(Entity entity, float3 newLocalPosition, ref ComponentBroker componentBroker)
        {
            var handle = GetHierarchyHandle(entity, ref componentBroker);
            if (handle.isNull)
            {
            ...
            SetTickedLocalPosition(handle, newLocalPosition, ref componentBroker);
        }
        ...
        /// <param name="key">A key to ensure the hierarchy is safe to access</param>
        /// <param name="componentBroker">A ComponentBroker with write access to TickedWorldTransform and read access to RootReference, EntityInHierarchy, and EntityInHierarchyCleanup</param>
        public static void SetTickedLocalPosition(Entity entity, float3 newLocalPosition, TransformsKey key, ref ComponentBroker componentBroker)
        {
            var handle = GetHierarchyHandle(entity, ref componentBroker);
            if (handle.isNull)
            {
        ...
        /// <param name="newLocalPosition">The new local position value</param>
        /// <param name="componentBroker">A ComponentBroker with write access to TickedWorldTransform and read access to RootReference, EntityInHierarchy, and EntityInHierarchyCleanup</param>
        public static void SetTickedLocalPosition(EntityInHierarchyHandle handle, float3 newLocalPosition, ref ComponentBroker componentBroker)
        {
            if (handle.isCopyParent)
                return;
        ...
        /// <param name="key">A key to ensure the hierarchy is safe to access</param>
        /// <param name="componentBroker">A ComponentBroker with write access to TickedWorldTransform and read access to RootReference, EntityInHierarchy, and EntityInHierarchyCleanup</param>
        public static void SetTickedLocalPosition(EntityInHierarchyHandle handle, float3 newLocalPosition, TransformsKey key, ref ComponentBroker componentBroker)
        {
            if (handle.isCopyParent)
                return;
            key.Validate(handle.root.entity);
                                                  ...
                                                  ref BufferLookup<EntityInHierarchyCleanup>          entityInHierarchyCleanupLookupRO)
        {
            ...
            SetTickedLocalPosition(handle, newLocalPosition, ref transformLookupRW.GetCheckedLookup(entity, key), ref entityStorageInfoLookup);
        }
